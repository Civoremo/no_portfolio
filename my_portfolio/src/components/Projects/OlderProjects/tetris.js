								...
								<Modal.Body>
									...
									<div style={{ margin: "30px 20px" }}>
										...
										<p>
											...
											the XNA framework from Microsoft, which allowed developers to build games and
											apps for their phones and the Xbox.
										</p>
										<p>
											The game is in all essence Tetris and features a particle system and a high
											score board. The speed of falling pieces increases as lines are cleared, and a
											bonus score is awarded when Tetris (clearing 4 lines) is made.
										</p>
										<div
											style={{
												display: "flex",
