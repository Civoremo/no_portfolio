...
const Projects = () => {
	...
	function showMoreProjectsPart3() {
		let projectsDiv = document.getElementById("olderProjectsPart3");
		let showMoreProjectsLink = document.getElementById("showMoreProjectsLink2");
		if (projectsDiv.style.display === "none") {
			showMoreProjectsLink.style.display = "none";
			projectsDiv.style.display = "block";
		} else {
									...
									<div className="card-body">
										<div style={{ marginBottom: "20px" }}>
											...
											<p className="card-text">
												A team collaboration, organization, and communication tool which keeps track
												of a teams multi-platform documents, activities and conversations all in one
												place.
											</p>
											<ModalLink
												onClick={() => setLgProject1Show(true)}
												style={{ color: "#007bff" }}
											>
												Learn more
											</ModalLink>
											...
											>
												...
												<Modal.Body>
													...
													>
														...
														<p>
															Team was tasked with adding new features to an already existing
															codebase.
														</p>
														<p>
															New features included the ability to add files, to be able to organize
															files into folders, move files between folders, edit and delete files
															and folders.
														</p>
														<p>
															I was tasked with redeploying the back-end and adding the necessary
															code for the creation, editing, updating and deleting of files and
															folders.
														</p>
														<p>
															The first hurdle I had to overcome was the inadequate documentation
															for redeployment. After spending some hours familiarizing myself with
															the existing code and trying to follow the documentation for
															deployment, I kept running into the issue of the back-end working on
															local machines but not on the server.
															<br />
															Combing through all of the code, the issue was discovered; an
															undocumented environment variable.
														</p>
														<p>
															The real work could finally begin; learning about mongoDB, mongoose
															and graphQL.
															<br />
															<br />
															The following 4 weeks were some of the intense and most rewarding
															time; while constantly under the pressure to build out the back-end so
															the rest of the team could work on the front-end features, I had the
															opportunity to learn unfamiliar frameworks.
														</p>
														<p>
															Once the back-end was complete, I jumped to the front-end to help the
															team build out all the necessary components. My initial focus was on
															the the Drag-n-Drop functionality of files and folders. Next I chose
															to work on the editing of files and folders. Lastly I focused on my
															attention on the filter system of our newly implemented "Activity
															Timeline".
														</p>
														<div
															style={{
								...
								<div className="card" style={{ minWidth: "18rem" }}>
									...
									<div className="card-body">
										<div style={{ marginBottom: "20px" }}>
											...
											<p className="card-text">
												Responsive local business site with CRUD operations for customer signup and
												access to restricted info.
											</p>
											<ModalLink
												onClick={() => setLgProject2Show(true)}
												style={{ color: "#007bff" }}
											>
												Learn more
											</ModalLink>
											...
											>
												...
												<Modal.Body>
													...
													<div style={{ border: "1px solid red", margin: "30px 20px" }}>
														<p>
															Some text here with a more detailed explanation Some text here with a
															more detailed explanation Some text here with a more detailed
															explanation Some text here with a more detailed explanation Some text
															here with a more detailed explanation Some text here with a more
															detailed explanation Some text here with a more detailed explanation
								...
								<div className="card" style={{ minWidth: "18rem" }}>
									...
									<div className="card-body">
										<div style={{ marginBottom: "20px" }}>
											...
											<ModalLink
												onClick={() => setLgProject3Show(true)}
												style={{ color: "#007bff" }}
											>
												Learn more
											</ModalLink>
							...
							<div className="card" style={{ width: "14rem", margin: "3px 3px" }}>
								...
								<div className="card-body">
									<div style={{ marginBottom: "15px" }}>
										...
										<ModalLink
											onClick={() => setLgOlderProject1Show(true)}
											style={{ color: "#007bff" }}
										>
											Learn more
										</ModalLink>
										...
										>
											...
											<Modal.Body>
												...
												<div style={{ margin: "30px 20px" }}>
													<p>
														First attempt at making a game from scratch after learning the basics of
														C# and the XNA framework.
													</p>
													<p>
														Having built a few simple windows applications before; I had stubled
														across the XNA framework from Microsoft, which allowed developers to
														build games and apps for their phones and the Xbox.
													</p>
													<p>
														The game is in all essence Tetris and features a particle system and a
														high score board. The speed of falling pieces increases as lines are
														cleared, and a bonus score is awarded when Tetris (clearing 4 lines) is
														made.
													</p>
													<div
														style={{
							...
							<div className="card" style={{ width: "14rem", margin: "3px 3px" }}>
								...
								<div className="card-body">
									<div style={{ marginBottom: "15px" }}>
										...
										<ModalLink
											onClick={() => setLgOlderProject2Show(true)}
											style={{ color: "#007bff" }}
										>
											Learn more
										</ModalLink>
							...
							<div className="card" style={{ width: "14rem", margin: "3px 3px" }}>
								...
								<div className="card-body">
									<div style={{ marginBottom: "15px" }}>
										...
										<p className="card-text">
											API for creating and maintaing your own sports league.
										</p>
										<ModalLink
											onClick={() => setLgOlderProject3Show(true)}
											style={{ color: "#007bff" }}
										>
											Learn more
										</ModalLink>
							...
							<div className="card" style={{ width: "14rem", margin: "3px 3px" }}>
								...
								<div className="card-body">
									<div style={{ marginBottom: "15px" }}>
										...
										<ModalLink
											onClick={() => setLgOlderProject4Show(true)}
											style={{ color: "#007bff" }}
										>
											Learn more
										</ModalLink>
										...
										>
											...
											<Modal.Body>
												...
												<div style={{ margin: "30px 20px" }}>
													<p>
														Recreated a pixel-perfect version of an architect firm's site. Design
														files were provided along with the content and the challenge was to
														build the site according to the designs.
													</p>
													<p>
														The services page contains tabs that will change the content based on
														the button clicked.
													</p>
													<div
														style={{
