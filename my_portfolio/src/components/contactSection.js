					...
					<Container style={{ padding: "30px 70px" }}>
						<ContactSectionWrapper>
								...
								>
									<div className="form-group">
										<div className="form-row">
											<div
												className="col"
												style={{ minWidth: "300px", margin: "15px 0 15px 15px" }}
											>
												<label
									...
									>
										<Reaptcha sitekey={process.env.REACT_APP_RECAPTCHA} onVerify={this.onVerify} />
									</div>
									<button
							...
							<SocialLinksContainer>
								...
								>
									<a href="https://github.com/Civoremo" target="_blank" rel="noopener noreferrer">
